...
public class NormalMode extends AnchorPane {
	...
	protected void initalizeNewZombie(int code, Zombie zombie) {
		...
		if (GameController.getWaveType() == 1)
			zombie.setX((int) (Main.getWidth() + 150 + code * (200 - GameController.getWave() * 25)
					- 30 * factor * GameController.getWave()));
		else
			zombie.setX((int) (Main.getWidth() + 350 + code * (270 - GameController.getWave() * 20)
					- factor * 20 * GameController.getWave()));
