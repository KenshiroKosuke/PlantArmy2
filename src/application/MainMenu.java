...
public class MainMenu extends AnchorPane {
	private static ImageView imageView_Logo = new ImageView(
			new Image(ClassLoader.getSystemResource("Logo.png").toString()));
	private static ImageView imageView_Start = new ImageView(
			new Image(ClassLoader.getSystemResource("Start.png").toString()));
	private static ImageView imageView_Exit = new ImageView(
			new Image(ClassLoader.getSystemResource("Exit.png").toString()));
