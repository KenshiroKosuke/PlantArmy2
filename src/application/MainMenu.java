...
public class MainMenu extends AnchorPane{
	...
	private static ImageView imageView_Rules = new ImageView(new Image(ClassLoader.getSystemResource("Rules.png").toString()));
	...
	public MainMenu() {
        ...
        imageView_Start.relocate(Main.getWidth()/2,Main.getHeight()-100);
        this.getChildren().add(imageView_Start);
        
        imageView_Rules.setFitHeight(41);
        imageView_Rules.setPreserveRatio(true);
        imageView_Rules.relocate(Main.getWidth()/2+175,Main.getHeight()-100);
        this.getChildren().add(imageView_Rules);
